...
use Novikovvs\QueueMonitor\Controllers\ShowQueueMonitorController;
...
class RoutesTest extends TestCase
{
    public function testBasicRouteCreation()
    {
        ...
        $this->assertEquals('\Novikovvs\QueueMonitor\Controllers\ShowQueueMonitorController', $route->getAction('controller'));
    }
